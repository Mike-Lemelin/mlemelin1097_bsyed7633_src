...
namespace control_panel
{
    ...
    {
        public const string Broker = "p07da41d.ala.us-east-1.emqxsl.com";
        public const int Port = 8883;
        public const string Username = "Mlemelin1097";
        public const string Password = "1097";
        public const string BaseTopic = "SENG3030/#";
        public static readonly Dictionary<string, string> Devices = new()
        {
            { "Device 1", Device1Path },
            { "Device 2", Device2Path }
        };
